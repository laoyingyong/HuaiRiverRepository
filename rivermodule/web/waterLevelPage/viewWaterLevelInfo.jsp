...
<div class="container">
    <div class="row">
        <div class="col-sm-6 col-sm-offset-5" style="margin-top: 20px">

                <form class="form-inline">
                    <div class="form-group">
                        <label class="sr-only" for="name2">Email address</label>
                        <input type="text" class="form-control" id="name2" name="name2" placeholder="地点名称">
                    </div>
                    <div class="form-group">
                        <label class="sr-only" for="status2">Password</label>
                        <input type="text" class="form-control" id="status2" name="status2" placeholder="状态">
                    </div>
